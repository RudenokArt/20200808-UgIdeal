...
<div class="wallpaper_constructor-container">
 ...
 <div class="wallpaper_constructor-content">
  ...
  <div class="wallpaper_texture-block_wrapper" id="wallpaper_texture-block_wrapper">
    <div class="wallpaper_texture-block_arrow" id="wallpaper_texture-block_arrow-left">
      <i class="fa fa-chevron-circle-left" aria-hidden="true"></i>
    </div>
    <div class="wallpaper_texture-block" id="wallpaper_texture-block">
      <div class="wallpaper_texture-block_tape" id="wallpaper_texture-block_tape">
   ...
   <div class="wallpaper_texture-block_arrow" id="wallpaper_texture-block_arrow-right">
    <i class="fa fa-chevron-circle-right" aria-hidden="true"></i>
  </div>
  <!-- <div class="stop_clicker"></div> -->
</div>
    ...
    <div class="wallpaper_constructor-sidebar_options">
      <div>
        ...
        <table>
          ...
          <?php foreach (priceListSort() as $key => $value) : ?>
